...
namespace DialogueSystem
{
    ...
    public class DialogueGraphWindow : EditorWindow
    {
        ...
        void CreateGraphPane()
        {
            ...
            var panHintLabel = new Label("Alt + Mouse to Pan");
            panHintLabel.AddToClassList("toolbar-hint");
            panHintLabel.style.color = new Color(0.7f, 0.7f, 0.7f, 1f); // Subtle gray color
            panHintLabel.style.fontSize = 11;
            panHintLabel.style.unityFontStyleAndWeight = FontStyle.Italic;
            centerSection.Add(panHintLabel);
            ...
            rightSection.Add(validateButton);
            ...
            graphView.OnGraphChanged += (graph) => { m_LastGraphAsset = graph; };
        ...
        void ShowSpeechNodeInspector(SpeechNode speechNode)
        {
            ...
            var hasCharacterDatabases = databases.Length > 0 &&
                                        databases.Any(db =>
                                            db != null && db.Characters != null && db.Characters.Count > 0);
        ...
        void ShowConditionalNodeInspector(ConditionalNode conditionalNode)
        {
            ...
            var logEvaluationField =
                new PropertyField(serializedObject.FindProperty("logEvaluation"), "Log Evaluation");
        ...
        void ShowVariableSetNodeInspector(VariableSetNode variableSetNode)
        {
            ...
            var logOperationsField =
                new PropertyField(serializedObject.FindProperty("logOperations"), "Log Operations");
        ...
        VisualElement CreateCharacterDropdown(SerializedObject serializedObject, DialogueNode node)
        {
            ...
            dropdown.RegisterValueChangedCallback((ChangeEvent<string> evt) =>
            {
                ...
                EditorApplication.delayCall += () => { UpdateInspectorContent(); };
            });
